...
| **Bonus** | The `datahub-verify` Skill is **contributed upstream** — [datahub-project/datahub-skills#81](https://github.com/datahub-project/datahub-skills/pull/81), open, passing their checks, and clean under their own prettier and markdownlint configs. A claim-extraction dataset is published Apache-2.0 with attribution, notice, and a datasheet generated from the corpus itself. | [PR #81](https://github.com/datahub-project/datahub-skills/pull/81) · [`skills/datahub-verify`](skills/datahub-verify/) · [`data/claims/DATASHEET.md`](data/claims/DATASHEET.md) |
