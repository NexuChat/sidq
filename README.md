...
| 2 | `make check` | Python 3.12; package downloads on first use | 1134 tests, lint, format, types — 1133 passed, 1 optional integration skipped, with 84.52% branch coverage; the same gates CI runs. | ~60s after bootstrap |
