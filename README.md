...
| 2 | `make check` | Python 3.12; package downloads on first use | 1137 tests, lint, format, types — 1136 passed, 1 optional integration skipped, with 84.56% branch coverage; the same gates CI runs. | ~60s after bootstrap |
