...
| 2 | `make check` | Python 3.12; package downloads on first use | 1019 tests, lint, format, types — 1017 passed, 2 optional integrations skipped, with 83.85% branch coverage; the same gates CI runs. | ~60s after bootstrap |
