...
| 2 | `make check` | Python 3.12; package downloads on first use | 982 tests, lint, format, types — the same code-quality and regression checks CI runs. | ~60s after bootstrap |
